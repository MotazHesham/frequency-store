<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @endcan
        @can('frequancy_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.frequancies.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/frequancies") || request()->is("admin/frequancies/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-broadcast-tower c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.frequancy.title') }}
                </a>
            </li>
        @endcan
